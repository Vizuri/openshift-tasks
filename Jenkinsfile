      ...
      steps {
            container("skopeo") {
                sh  '''
                  ...
                  skopeo --debug copy --src-creds="$(oc whoami)":"$(oc whoami -t)" --src-tls-verify=false --dest-tls-verify=false --dest-creds=student1:workshop1! docker://image-registry.openshift-image-registry.svc:5000/dev-student1/tasks:latest docker://quay.apps.ocpws.kee.vizuri.com/student1/tasks:latest
                '''
            }
        }
    }
